...
def create_tables():
    ...
    try:
        ...
        if (
            ...
            and "65+" in total_age_group_counts.index
        ):
            ...
            ratio_data = pd.DataFrame({
                'Age Group': ['18-65', '65+'],
                'Distribution Percentage': [f'{percentage_20_65:.2f}%', f'{percentage_65_plus:.2f}%'],
            ...
            hemorrhagic_percentage = (
                total_strokes["hemorrhagic"] / total_stroke_count
            ) * 100
 
            stroke_data = pd.DataFrame({
                'Stroke Type': ['Ischemic', 'Hemorrhagic'],
                'Distribution Percentage': [f'{ischemic_percentage:.2f}%', f'{hemorrhagic_percentage:.2f}%'],
        ...
        plt.legend(
            title="Stroke Type", loc="upper right", fontsize=10, title_fontsize=11
        )
        plt.tight_layout()
