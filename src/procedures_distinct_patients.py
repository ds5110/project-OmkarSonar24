...
# Create a mapping dictionary for procedure_concept_id to the new names
procedure_name_map = {
...
df1['concept_name'] = df1['procedure_concept_id'].map(procedure_name_map)
df2['concept_name'] = df2['procedure_concept_id'].map(procedure_name_map)
